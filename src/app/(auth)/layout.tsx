...
export const metadata: Metadata = {
  title: "Authentication | EcoCollect Panabo",
  description: "Sign in or create an account for EcoCollect Panabo",
};
      ...
      <header className="relative z-10 py-4">
        <div className="container mx-auto px-4 flex justify-center">
          <Link href="/" className="inline-flex items-center gap-2">
            <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-gradient-to-br from-primary-500 to-primary-600 shadow-eco">
              <Recycle className="w-5 h-5 text-white" />
            </div>
            <span className="font-bold text-lg text-primary-800">{APP_NAME}</span>
          </Link>
        </div>
      </header>
